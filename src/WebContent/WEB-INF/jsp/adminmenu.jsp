...
<h1>管理者用ページ</h1>
        <button onclick="location.href='/hydrangea/src/servlet/NewShopServlet.java'" id="button1" class="retu" style="vertical-align: middle;">ページ作成<br>編集</button>
        <button onclick="location.href='/hydrangea/src/servlet/InformationCreateServlet.java'" id="button1" class="retu">通知</button>
        <button onclick="location.href=''" id="button1" class="retu">登録</button>
